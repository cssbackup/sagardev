...
import Home from "@/themes/template-3";
import Header from "@/themes/template-3/Header";
import Footer from "@/themes/template-3/Footer";
import PageBanner from "@/themes/template-3/pages/PageBanner";
import About from "@/themes/template-3/pages/About";
import Contact from "@/themes/template-3/pages/Contact";
import Properties from "@/themes/template-3/pages/Properties";
import Blog from "@/themes/template-3/pages/Blog";
import Services from "@/themes/template-3/pages/Services";
import Privacy from "@/themes/template-3/pages/Privacy";
import Terms from "@/themes/template-3/pages/Terms";
import ErrorPage from "@/themes/template-2/pages/Error";
import Gallery from "@/themes/template-3/pages/Gallery";
import Awards from "@/themes/template-3/pages/Awards";
import Career from "@/themes/template-3/pages/Career";
import Csr from "@/themes/template-3/pages/Csr";
import Mission from "@/themes/template-3/pages/Mission";
...
export const template3Pack: ThemePack = {
  id: "template-3",
  shellClass: themeShellClass["template-3"],
  Home,
