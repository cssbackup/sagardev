...
export default async function BuyRoutePage({ searchParams }: Props) {
  ...
  return (
    <div id="top" className={pack.shellClass}>
      ...
      <main>
        <Suspense
          fallback={
            <div className="px-4 py-16 text-sm text-[#141414]/55">
              Loading buy listings…
            </div>
          }
        >
          <Buy data={data} theme={theme} />
        </Suspense>
      </main>
      <Footer data={data} />
    </div>
